...
const PromotionEdit = () => {
  ...
  useEffect(() => {
      ...
      promotionServices.Details(params.id)
      .then((data) => {
          const values = {
            title: data?.data?.title || '',
            promotion_type: data?.data?.promotion_type || '',
            coupon_id: data?.data?.coupon?._id
          }
          getCouponOptions(values.promotion_type);
                ...
                <div className="col-lg-12 col-md-12 animation_fade">
                  <div className="card custom-card">
                    <div className="card-body">
                      <div>
                        <h6 className="main-content-label mb-3">Edit Promotion</h6>
                      </div>
                      <div className="row row-sm">
