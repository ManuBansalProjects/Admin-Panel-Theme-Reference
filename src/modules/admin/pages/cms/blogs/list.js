...
const BlogTable = () => {
  ...
  const viewfunction = (row) => {
    navigate(`/admin/cms/blogs/view/${row._id}`);
  };
  const Editfunction = (row) => {
    navigate(`/admin/cms/blogs/${params.pgno}/edit/${row._id}`);
  };
  ...
  const ChangeStatus = (data, Num) => {
    ...
    Swal.fire({
      ...
      title: t(`Are you sure you want to ${Num === false ? "deactivate" : "activate"} this Page ?`),
      icon: "warning",
        ...
        <div className="card custom-card overflow-hidden">
          <div className="card-body">
            <div className="d-flex justify-content-between align-items-center mb-4">
              <h6 className="main-content-label">Blogs</h6>
              <div className="d-flex align-items-center">
                ...
                >
                  ...
                  <button
                    ...
                    onClick={() => navigate(`/admin/cms/blogs/add`)}
                  >
                    {t("btn_add_new")}
                  </button>
              </div>
