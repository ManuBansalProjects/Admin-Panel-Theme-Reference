...
const UserSubscriptionHistoryDetails = (props) => {
  ...
  const breadcrumbs = [
    ...
    { title: t("User"), url: `/admin/user-management/user/list/${params.userListPgno}` },
    { title: t("Subscription History"), url: `/admin/user-management/user/${params.userListPgno}/subscription-history/list/${params.pgno}/${params.userId}` },
          ...
          <div className="card custom-card">
            ...
            <div className="ml-4 back-button mx-0">
              <button
                ...
                type="button"
                onClick={() =>
                  navigate(`/admin/user-management/user/${params.userListPgno}/subscription-history/list/${params.pgno}/${params.userId}`)
                }
              >
...
export default UserSubscriptionHistoryDetails;
