...
// };
    ...
    <div className="container vh-70 d-flex flex-column video-call-bg p-0">
      <div className="row flex-grow-1 m-0">
        ...
        <h3 className='text-danger'>Time Left {formatCallDurationCounter(timeLeftCounter)}</h3>
        {
          // joined 
          // &&
          <div className='d-flex justify-content-between align-items-center p-3 mt-2'>
            ...
            <div className='gap-3'>
              ...
              <button className="btn btn-danger px-4 fw-bold" onClick={() => {
